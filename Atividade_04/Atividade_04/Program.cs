...
namespace Atividade_04
{
    ...
    { /* 4-	Faça um algoritmo que leia dois valores booleanos (lógicos) e determine se ambos são
       *     VERDADEIRO ou FALSO. */
        static void Main(string[] args)
        {
            ...
            numero1 = bool.Parse(Console.ReadLine());
            Console.WriteLine(" numero2 ");
            numero2 = bool.Parse(Console.ReadLine());
